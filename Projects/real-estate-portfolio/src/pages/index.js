...
export default function Home() {
  ...
  const projectName = "Real Estate Portfolio";
  const projectInitial = "R";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h2 className="text-6xl md:text-7xl font-bold mb-6 leading-tight text-gray-900">
          "Manage Your Real Estate Investments Effortlessly"
        </h2>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Link href="/feature-property-management" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4A90E2' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Property management</h3>
            <p className="text-gray-600 leading-relaxed">Discover how property management can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4A90E2' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-financial-analysis-tools" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4A90E2' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Financial analysis tools</h3>
            <p className="text-gray-600 leading-relaxed">Discover how financial analysis tools can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4A90E2' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-portfolio-tracking" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4A90E2' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Portfolio tracking</h3>
            <p className="text-gray-600 leading-relaxed">Discover how portfolio tracking can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4A90E2' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-market-trend-analysis" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4A90E2' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Market trend analysis</h3>
            <p className="text-gray-600 leading-relaxed">Discover how market trend analysis can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4A90E2' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-user-authentication-and-roles" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4A90E2' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">User authentication and roles</h3>
            <p className="text-gray-600 leading-relaxed">Discover how user authentication and roles can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4A90E2' }}>
              Learn more →
            </span>
          </div>
