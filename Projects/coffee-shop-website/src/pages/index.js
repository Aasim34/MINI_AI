...
export default function Home() {
  ...
  const projectName = "Coffee Shop Website";
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Link href="/feature-user-authentication-and-profiles" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#6F4C3E' }}>
              ✓
            </div>
            ...
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#6F4C3E' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-online-ordering-system" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#6F4C3E' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Online ordering system</h3>
            <p className="text-gray-600 leading-relaxed">Discover how online ordering system can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#6F4C3E' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-menu-display-with-seasonal-specials" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#6F4C3E' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Menu display with seasonal specials</h3>
            <p className="text-gray-600 leading-relaxed">Discover how menu display with seasonal specials can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#6F4C3E' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-customer-reviews-and-ratings" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#6F4C3E' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Customer reviews and ratings</h3>
            <p className="text-gray-600 leading-relaxed">Discover how customer reviews and ratings can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#6F4C3E' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-blog-section-for-coffee-related-articles" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#6F4C3E' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Blog section for coffee-related articles</h3>
            <p className="text-gray-600 leading-relaxed">Discover how blog section for coffee-related articles can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#6F4C3E' }}>
              Learn more →
            </span>
          </div>
