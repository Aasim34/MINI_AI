  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Link href="/feature-user-registration-and-authentication" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            ...
            <h3 className="text-xl font-bold mb-3">User registration and authentication</h3>
            <p className="text-gray-600 leading-relaxed">Discover how user registration and authentication can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-workout-logging" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Workout logging</h3>
            <p className="text-gray-600 leading-relaxed">Discover how workout logging can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-goal-setting" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Goal setting</h3>
            <p className="text-gray-600 leading-relaxed">Discover how goal setting can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-progress-tracking-with-charts" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Progress tracking with charts</h3>
            <p className="text-gray-600 leading-relaxed">Discover how progress tracking with charts can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-social-sharing-and-challenges" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Social sharing and challenges</h3>
            <p className="text-gray-600 leading-relaxed">Discover how social sharing and challenges can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
