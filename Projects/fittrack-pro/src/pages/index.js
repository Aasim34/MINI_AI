...
export default function Home() {
  ...
  const projectName = "FitTrack Pro";
  const projectInitial = "F";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Link href="/feature-user-authentication-and-profiles" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            ...
            <h3 className="text-xl font-bold mb-3">User authentication and profiles</h3>
            <p className="text-gray-600 leading-relaxed">Discover how user authentication and profiles can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-customizable-workout-plans" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Customizable workout plans</h3>
            <p className="text-gray-600 leading-relaxed">Discover how customizable workout plans can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-nutrition-tracking-and-meal-planning" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Nutrition tracking and meal planning</h3>
            <p className="text-gray-600 leading-relaxed">Discover how nutrition tracking and meal planning can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-progress-tracking-and-analytics" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Progress tracking and analytics</h3>
            <p className="text-gray-600 leading-relaxed">Discover how progress tracking and analytics can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-community-and-social-sharing-features" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#4CAF50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Community and social sharing features</h3>
            <p className="text-gray-600 leading-relaxed">Discover how community and social sharing features can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#4CAF50' }}>
              Learn more →
            </span>
          </div>
