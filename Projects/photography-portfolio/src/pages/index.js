...
export default function Home() {
  ...
  const projectName = "Photography Portfolio";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h2 className="text-6xl md:text-7xl font-bold mb-6 leading-tight text-gray-900">
          "Showcase Your Photography Masterpieces"
        </h2>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Link href="/feature-image-gallery-with-categories" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#3E4E50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Image gallery with categories</h3>
            <p className="text-gray-600 leading-relaxed">Discover how image gallery with categories can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#3E4E50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-responsive-design" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#3E4E50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Responsive design</h3>
            <p className="text-gray-600 leading-relaxed">Discover how responsive design can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#3E4E50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-contact-form-for-inquiries" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#3E4E50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Contact form for inquiries</h3>
            <p className="text-gray-600 leading-relaxed">Discover how contact form for inquiries can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#3E4E50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-integration-with-social-media" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#3E4E50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Integration with social media</h3>
            <p className="text-gray-600 leading-relaxed">Discover how integration with social media can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#3E4E50' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-search-engine-optimization" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#3E4E50' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Search engine optimization</h3>
            <p className="text-gray-600 leading-relaxed">Discover how search engine optimization can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#3E4E50' }}>
              Learn more →
            </span>
          </div>
