    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h2 className="text-6xl md:text-7xl font-bold mb-6 leading-tight text-gray-900">
          "Elevate Your Knowledge with Test App"
        </h2>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100">
          ...
          <p className="text-gray-600 leading-relaxed">user authentication tailored to meet your needs with enterprise-grade performance.</p>
          <a href="#" className="mt-4 inline-block font-semibold transition">
            Explore more →
          </a>
        </div>
        <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100">
          ...
          <p className="text-gray-600 leading-relaxed">data visualization tailored to meet your needs with enterprise-grade performance.</p>
          <a href="#" className="mt-4 inline-block font-semibold transition">
            Explore more →
          </a>
        </div>
        <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100">
          ...
          <p className="text-gray-600 leading-relaxed">real-time updates tailored to meet your needs with enterprise-grade performance.</p>
          <a href="#" className="mt-4 inline-block font-semibold transition">
            Explore more →
          </a>
        </div>
        <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100">
          ...
          <p className="text-gray-600 leading-relaxed">api integration tailored to meet your needs with enterprise-grade performance.</p>
          <a href="#" className="mt-4 inline-block font-semibold transition">
            Explore more →
          </a>
        </div>
