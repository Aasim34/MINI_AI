...
export default function Home() {
  ...
  const projectName = "Dog Walker Marketplace";
  const projectInitial = "D";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h2 className="text-6xl md:text-7xl font-bold mb-6 leading-tight text-gray-900">
          "Find Your Perfect Dog Walker Today!"
        </h2>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Link href="/feature-real-time-gps-tracking" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFCC00' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Real-time GPS tracking</h3>
            <p className="text-gray-600 leading-relaxed">Discover how real-time gps tracking can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFCC00' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-user-reviews-and-ratings" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFCC00' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">User reviews and ratings</h3>
            <p className="text-gray-600 leading-relaxed">Discover how user reviews and ratings can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFCC00' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-user-profiles-for-dog-owners-and-walkers" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFCC00' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">User profiles for dog owners and walkers</h3>
            <p className="text-gray-600 leading-relaxed">Discover how user profiles for dog owners and walkers can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFCC00' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-booking-and-payment-processing" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFCC00' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Booking and payment processing</h3>
            <p className="text-gray-600 leading-relaxed">Discover how booking and payment processing can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFCC00' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-push-notifications-for-updates" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFCC00' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Push notifications for updates</h3>
            <p className="text-gray-600 leading-relaxed">Discover how push notifications for updates can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFCC00' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-search-and-filter-functionality" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFCC00' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Search and filter functionality</h3>
            <p className="text-gray-600 leading-relaxed">Discover how search and filter functionality can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFCC00' }}>
              Learn more →
            </span>
          </div>
