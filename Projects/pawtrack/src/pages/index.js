...
export default function Home() {
  ...
  const projectName = "PawTrack";
  const projectInitial = "P";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
          "A dog walking marketplace with real-time GPS tracking, reviews, and ratings."
        </p>
      ...
      <section id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <Link href="/feature-real-time-gps-tracking-of-dog-walkers" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFB74D' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Real-time GPS tracking of dog walkers</h3>
            <p className="text-gray-600 leading-relaxed">Discover how real-time gps tracking of dog walkers can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFB74D' }}>
              Learn more →
            </span>
          </div>
        </Link>
        ...
        <Link href="/feature-booking-and-scheduling-system" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFB74D' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Booking and scheduling system</h3>
            <p className="text-gray-600 leading-relaxed">Discover how booking and scheduling system can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFB74D' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-in-app-messaging" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFB74D' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">In-app messaging</h3>
            <p className="text-gray-600 leading-relaxed">Discover how in-app messaging can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFB74D' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-reviews-and-ratings-for-dog-walkers" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFB74D' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Reviews and ratings for dog walkers</h3>
            <p className="text-gray-600 leading-relaxed">Discover how reviews and ratings for dog walkers can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFB74D' }}>
              Learn more →
            </span>
          </div>
        </Link>
        <Link href="/feature-payment-processing" className="block">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-gray-100 cursor-pointer">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 text-white font-bold text-xl" style={{ backgroundColor: '#FFB74D' }}>
              ✓
            </div>
            <h3 className="text-xl font-bold mb-3">Payment processing</h3>
            <p className="text-gray-600 leading-relaxed">Discover how payment processing can transform your workflow with our advanced solution.</p>
            <span className="mt-4 inline-block font-semibold transition" style={{ color: '#FFB74D' }}>
              Learn more →
            </span>
          </div>
